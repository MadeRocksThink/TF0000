...
const destination = resolve(repositoryRoot, "apps", "vscode-extension", "bin", executable);

if (!existsSync(source)) {
  throw new Error(`Build the native host before packaging the VS Code extension: ${source}`);
}
